...
using DesignPatterns.AbstractFactory.PizzaStore;
...
namespace UnitTestProject
{
    ...
    public class AbstractFactoryTests
    {
        ...
        {
            DesignPatterns.AbstractFactory.PizzaStore.PizzaStore nyStore =
                new NYPizzaStore();
        ...
        {
            DesignPatterns.AbstractFactory.PizzaStore.PizzaStore chicagoStore =
